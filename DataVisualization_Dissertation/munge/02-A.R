...
ncl_final_lat_lon = ncl_final_lat_lon[,-c(7,8,10)]
...
ncl_final_lat_lon = ncl_final_lat_lon[,-c(7)]

names(ncl_final_lat_lon)[7] = "Longitude"
names(ncl_final_lat_lon)[8] = "Latitude"
