...
#drop the columns:
ncl_final_lat_lon_no2 = ncl_final_lat_lon_no2[,c(2,1,3,9)]
ncl_final_lat_lon_pm10 = ncl_final_lat_lon_pm10[,c(2,1,3,9)]

mcu_final_lat_lon_no2 = mcu_final_lat_lon_no2[,c(1,5,6,9)]
mcu_final_lat_lon_pm10 = mcu_final_lat_lon_pm10[,c(1,5,6,9)]
