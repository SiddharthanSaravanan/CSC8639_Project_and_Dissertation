...
#### 3.1.3.1 Welch T-Test

The Welch T-Test was performed between the two EV's - NO_2 and PM_10. The dataset obtained from step 3.1.2 has been used from which the dataset has been filtered and stored separately for each cities. The values of NO_2 and PM_10 of each cities are stored separately in an array from which Welch T-Test was performed. 
